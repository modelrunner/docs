...
export default function HomePage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setResult(null);
    try {
      // Input follows PredictionRequest schema from OpenAPI
      const response = await modelrunner.subscribe("bytedance/sdxl-lightning-4step", {
        input: {
          prompt,
    ...
    <main className="mx-auto max-w-2xl p-6 space-y-6">
      ...
      {result && (
        <section className="space-y-2">
          ...
          {/* Status and timings from GetResultResponse */}
          ...
          {/* Render output based on OpenAPI GetResultResponse.output */}
