...
<Columns cols={2}>
  ...
  <Card title="Deploy on Serverless GPUs" icon="microchip" href="/guides/serverless-gpus/overview">
    Run your own container workload on a GPU we manage — scale-to-zero, per-second billing, and the same queue API as the catalog.
  </Card>
