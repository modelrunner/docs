...
description: "Run LLMs through an OpenAI-compatible chat completions endpoint — one base URL per model, your existing SDKs and tools, streaming, tool calling and JSON mode — plus the Anthropic-compatible endpoint Claude Code uses."
icon: "message-lines"
---
